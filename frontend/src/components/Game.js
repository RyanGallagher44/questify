...
const Game = () => {
    ...
    if (loading) {
        return(
            <div class="mt-96 spinner-border animate-spin inline-block w-16 h-16 border-4 rounded-full text-gray-50" role="status">
        ...
        return(
            ...
            <section class="p-4 sm:ml-64 relative pt-16 bg-blueGray-50">
                <div class="container mx-auto">
                <div class="flex flex-wrap items-center">
                    <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-500">
                        <img alt="..." src={gameData.imageUrl} class="w-full align-middle rounded-t-lg" />
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="relative flex flex-col mt-4">
                            ...
                            {gameData.releaseDate &&
                                <div>
                                    <h6 class="text-xl mb-1 font-semibold">Release Date</h6>
                            ...
                            {!gameData.releaseDate &&
                                <div>
                                    <h6 class="text-xl mb-1 font-semibold">Expected Release Date</h6>
                                    <p class="mb-4 text-blueGray-500">
                        ...
                        <div class="relative flex flex-col min-w-0">
                            ...
                            <ul>
                                {gameData.genres.map((genre) => {
                                    return <li class="text-blueGray-500">{genre}</li>
                                })}
                            </ul>
                            </div>
                        </div>
                        ...
                        <div class="relative flex flex-col min-w-0 mt-4">
                            ...
                            <h6 class="text-xl mb-1 font-semibold">Developers</h6>
                            <ul>
                                {gameData.developers.map((developer) => {
                                    return <li class="text-blueGray-500">{developer}</li>
                                })}
                            </ul>
                            </div>
                        </div>
                        <div class="relative flex flex-col min-w-0">
                            ...
                            <h6 class="text-xl mb-1 font-semibold">Publishers</h6>
                            <ul>
                                {gameData.publishers.map((publisher) => {
                                    return <li class="text-blueGray-500">{publisher}</li>
                                })}
                            </ul>
                            </div>
                        </div>
